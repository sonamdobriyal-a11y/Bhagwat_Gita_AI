...
function NavLink({
  ...
  return (
    ...
    >
      {active && (
        <span
          className="absolute inset-0 -z-10 rounded-full bg-white/80 shadow-sm shadow-gita-earth/5 ring-1 ring-gita-saffron/20 dark:bg-gita-chariot/80"
          aria-hidden
        />
      )}
      {label}
...
export function AppNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/40 bg-gita-ivory/75 backdrop-blur-xl backdrop-saturate-150 shadow-[0_1px_0_rgba(143,94,58,0.05)] dark:border-gita-line/60 dark:bg-gita-ivory/90 dark:shadow-[0_1px_0_rgba(0,0,0,0.2)]">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3.5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          {loading ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden rounded-full border border-gita-line/80 bg-gita-chariot px-3 py-1.5 text-xs font-semibold text-gita-earth transition hover:border-gita-saffron/35 hover:text-gita-peacock sm:inline"
              >
                Out
              </button>
            </div>
            ...
            <button
              ...
              className="rounded-full border border-gita-line/90 bg-gradient-to-b from-orange-50 to-white px-4 py-2 text-xs font-bold uppercase tracking-wider text-gita-earth shadow-sm transition hover:border-gita-saffron/35 hover:shadow-md disabled:opacity-45 dark:from-gita-chariot dark:to-gita-field-warm sm:text-sm sm:normal-case sm:tracking-normal"
            >
              Sign in
            </button>
          )}
          ...
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-xl border border-gita-line/60 bg-white/50 text-gita-earth dark:bg-gita-chariot/80 md:hidden"
            aria-expanded={open}
      ...
      {open && (
        <div className="border-t border-gita-line/40 bg-gita-ivory/95 px-4 py-4 dark:bg-gita-ivory md:hidden">
          <div className="mb-3 flex items-center justify-between sm:hidden">
            <span className="text-xs font-semibold uppercase tracking-wider text-gita-muted">Appearance</span>
