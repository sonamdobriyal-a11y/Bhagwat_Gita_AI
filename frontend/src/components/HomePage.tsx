...
function VerseCarousel() {
  ...
  return (
    <div className={`transition-opacity duration-200 ${fading ? "opacity-0" : "opacity-100"}`}>
      <header className="mb-8 flex flex-wrap items-baseline justify-between gap-3 border-b border-slate-200 dark:border-ink-700 pb-4">
        <div className="flex items-center gap-3">
          <span className="font-mono text-xs font-medium text-teal-800 dark:text-teal-200 bg-teal-50 dark:bg-teal-950/50 px-2 py-0.5 rounded-sm border border-teal-200/80 dark:border-teal-800/60">
            BG {v.ref}
          </span>
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-ink-400">{v.chapter}</span>
        </div>
        <p className="text-xs text-slate-500 dark:text-ink-400">Plain English · echoes the pause before the armies move</p>
      </header>
      <blockquote className="font-display text-xl md:text-[1.35rem] leading-[1.75] text-slate-800 dark:text-ink-100 font-normal not-italic pl-6 border-l-[3px] border-teal-500 bg-slate-50 dark:bg-ink-800/80 py-4 pr-4 rounded-r-2xl">
        {v.text}
      </blockquote>
        ...
        {VERSES.map((_, i) => (
          <button
            ...
            className={`rounded-sm transition-colors h-1.5 ${
              i === active ? "w-10 bg-teal-600" : "w-2 bg-slate-200 dark:bg-ink-700 hover:bg-teal-300 dark:hover:bg-teal-600"
            }`}
          />
        ))}
      </div>
  ...
  return (
    <div className="relative min-h-screen theme-page font-sans">
      ...
      <main className="relative z-[1] mx-auto max-w-6xl px-5 pb-24 pt-12 sm:px-8 sm:pt-16">
        ...
        {/* Hero */}
        <section className="relative grid gap-12 border-b border-slate-200 dark:border-ink-700/80 dark:border-ink-700/80 pb-20 lg:grid-cols-[minmax(0,1.12fr)_minmax(260px,1fr)] lg:gap-16">
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 dark:border-ink-700/80 bg-gita-chariot dark:bg-ink-800 p-8 shadow-sm shadow-slate-200/60 dark:shadow-black/20 sm:p-10">
            <div
            ...
            <h1 className="font-display text-[1.85rem] font-semibold leading-[1.1] tracking-tight text-slate-900 dark:text-ink-50 sm:text-5xl lg:text-[3.25rem]">
            ...
            <p className="mt-7 max-w-xl text-[1.05rem] leading-[1.75] text-slate-600 dark:text-ink-300">
          ...
          <div className="flex flex-col gap-10">
            <figure className="mx-auto w-full max-w-[340px] lg:mx-0">
              <div className="relative aspect-square w-full overflow-hidden rounded-[2rem] border border-slate-200 dark:border-ink-700/80 bg-gradient-to-br from-slate-50 to-teal-50/50 dark:from-ink-800 dark:to-teal-950/30 shadow-lg shadow-slate-200/50 dark:shadow-black/20 ring-1 ring-teal-100 dark:ring-teal-900/40">
                <Image
                  src="/chravyuh.png"
            ...
            <div className="rounded-[1.75rem] border border-slate-200 dark:border-ink-700/80 bg-slate-50 dark:bg-ink-800/50 p-6">
              <div className="mx-auto mb-6 flex max-w-[240px] flex-col items-center gap-4 lg:mx-0 lg:flex-row lg:justify-start">
                ...
                <span className="text-sm text-slate-700 dark:text-ink-200">
          ...
          <div className="flex flex-wrap justify-center gap-12 border-t border-slate-200 dark:border-ink-700/80 pt-12 sm:gap-16 lg:col-span-2">
            {[
        ...
        {/* Sample dialogue */}
        <section id="dialogue" className="relative border-b border-slate-200 dark:border-ink-700/80 py-20">
          <div className="mb-10 max-w-2xl">
            <p className="mb-2 text-[0.7rem] font-bold uppercase tracking-[0.14em] text-indigo-700">The two camps in one frame</p>
            <h2 className="font-display text-[1.75rem] font-semibold tracking-tight text-slate-900 dark:text-ink-50 sm:text-[2rem]">
          ...
          <div className="mx-auto max-w-xl rounded-[1.75rem] border border-slate-200 dark:border-ink-700/80 bg-gita-chariot dark:bg-ink-800 p-7 shadow-md shadow-slate-200/50 dark:shadow-black/20 sm:p-8">
            <div className="mb-6 flex justify-end gap-3">
              <div className="max-w-[86%] text-right">
                ...
                <div className="inline-block rounded-2xl border border-rose-100 dark:border-rose-900/40 bg-gradient-to-br from-rose-50 to-gita-ivory dark:from-rose-950/40 dark:to-ink-800 px-4 py-3 text-left text-[15px] leading-relaxed text-slate-800 dark:text-ink-100 shadow-sm">
            ...
            <div className="flex justify-start gap-3">
              ...
              <div className="max-w-[86%]">
                ...
                <div className="rounded-2xl border border-slate-100 dark:border-ink-700 border-l-[3px] border-l-teal-500 bg-slate-50 dark:bg-ink-800/90 px-4 py-3 text-[15px] leading-relaxed text-slate-800 dark:text-ink-100 shadow-sm">
        ...
        <section id="text" className="scroll-mt-28 py-20">
          ...
          {[
            ...
            const accents = [
              "border-teal-200/80 bg-gradient-to-br from-gita-ivory to-teal-50/70 dark:from-ink-800 dark:to-teal-950/40",
              "border-violet-200/80 bg-gradient-to-br from-gita-ivory to-violet-50/70 dark:from-ink-800 dark:to-violet-950/40",
              "border-rose-200/80 bg-gradient-to-br from-gita-ivory to-rose-50/70 dark:from-ink-800 dark:to-rose-950/40",
              "border-sky-200/80 bg-gradient-to-br from-gita-ivory to-sky-50/70 dark:from-ink-800 dark:to-sky-950/40",
            ];
            ...
            >
              ...
              <p className="mt-2 text-[14px] leading-relaxed text-slate-600 dark:text-ink-300">{f.body}</p>
            </article>
            );
          })}
          </MobileCarousel>
        ...
        {/* Verse block */}
        <section className="relative border-t border-slate-200 dark:border-ink-700/80 py-20">
          <div className="grid gap-12 lg:grid-cols-[1fr_320px]">
            <VerseCarousel />
            <aside className="h-fit rounded-[1.75rem] border border-indigo-100/80 dark:border-indigo-900/40 bg-indigo-50/40 dark:bg-indigo-950/30 p-7 lg:sticky lg:top-28">
        ...
        {/* Procedure */}
        <section className="relative border-t border-slate-200 dark:border-ink-700/80 py-16">
          <h2 className="mb-12 font-display text-[1.75rem] font-semibold tracking-tight text-slate-900 dark:text-ink-50">
          ...
          {[
              ...
              <li key={step} className="rounded-2xl border border-slate-200 dark:border-ink-700/80 bg-gita-chariot dark:bg-ink-800 p-5 list-none">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-slate-700/20 bg-gradient-to-br from-slate-800 via-teal-900 to-indigo-950 px-8 py-16 text-center text-white shadow-xl shadow-slate-900/15 sm:px-12">
          ...
          <div className="relative">
            ...
            <Link
              href="/chat"
              className="inline-flex rounded-full bg-gita-ivory dark:bg-ink-800 px-8 py-3.5 text-sm font-bold text-teal-900 dark:text-teal-100 shadow-lg shadow-black/10 transition hover:bg-teal-50 dark:hover:bg-teal-900/40"
            >
      ...
      <footer className="border-t border-slate-200 dark:border-ink-700 bg-gita-chariot dark:bg-ink-900 px-5 py-10 sm:px-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 sm:flex-row">
          <p className="font-display text-sm font-semibold text-slate-800 dark:text-ink-100">Bhagavad Gītā AI</p>
          <p className="text-center text-[12px] text-slate-500 dark:text-ink-400">
            © {new Date().getFullYear()} Bhagavad Gītā AI
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-[13px] text-slate-600 dark:text-ink-300">
